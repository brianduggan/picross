...
Picross.prototype.markSpace = function(status){
    ...
    this.moveBuffer[this.bufferPosition] = savedMove;
...
Picross.prototype.undoMove = function(){
    console.log(this.bufferPosition);
    if (this.bufferPosition){
        var lastMove = this.moveBuffer[this.bufferPosition - 1];
...
Picross.prototype.redoMove = function(){
    console.log(this.bufferPosition);
    var redoMove = this.moveBuffer[this.bufferPosition];
    if (redoMove){
